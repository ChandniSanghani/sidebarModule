...
@objc public protocol CustomSideMenuDelegate {
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, shouldRecognizeGesture recognizer: UIGestureRecognizer, simultaneouslyWith otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, gestureRecognizer: UIGestureRecognizer, shouldRequireFailureOf otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, gestureRecognizer: UIGestureRecognizer, shouldBeRequiredToFailBy otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, didRecognizePanGesture recognizer: UIPanGestureRecognizer)
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, willShowMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, didShowMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, willHideMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: CustomSideMenu, didHideMenuViewController menuViewController: UIViewController)
}

@IBDesignable open class CustomSideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    public weak var delegate: CustomSideMenuDelegate?
    ...
    override open func viewDidLoad() {
        ...
        button.addTarget(self, action: #selector(CustomSideMenu.hideMenuViewController), for: .touchUpInside)
        ...
        if self.panGestureEnabled {
            ...
            let panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(CustomSideMenu.panGestureRecognized(_:)))
    ...
    func showLeftMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
            ...
            self.contentViewContainer.frame.size.height = (self.contentViewController?.view.frame.height)!
